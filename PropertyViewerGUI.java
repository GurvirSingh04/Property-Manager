 ...
 * @author Michael Kölling, David J Barnes, and Josh Murphy and Gurvir Singh (K23010952)
 * @version 3.0
 */
public class PropertyViewerGUI
{
    ...
    {
        int views = viewer.getNumberOfPropertiesViewed();
        int averagePrice = viewer.averagePropertyPrice();
        String statistics = "Total Views: " + views + "\n" + "Average property price: £ " + averagePrice;
        // Creating a new window to display the statistics
        JOptionPane.showMessageDialog(frame, statistics, "Statistics", JOptionPane.PLAIN_MESSAGE);
    }
